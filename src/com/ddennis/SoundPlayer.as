package com.ddennis {
	...
	public class SoundPlayer extends MovieClip {
		...
		/*
 		...
 		private function setVolume (e:Event):void {
			/*						
			var transform:SoundTransform = sc.soundTransform;
			trace ("SoundPlayer.as > volValue  = "+__controls.volValue)
			transform.volume = __controls.volValue
			sc.soundTransform = transform;		
			*/
		}
